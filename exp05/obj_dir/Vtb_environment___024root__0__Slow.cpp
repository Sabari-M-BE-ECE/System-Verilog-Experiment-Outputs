...
#endif
            VL_FATAL_MT("tb_environment.sv", 3, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 100 tries");
        }
...
VL_ATTR_COLD void Vtb_environment___024root___eval_triggers_vec__stl(Vtb_environment___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_environment___024root___eval_triggers_vec__stl\n"); );
    Vtb_environment__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtb_environment___024root___eval_stl(Vtb_environment___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_environment___024root___eval_stl\n"); );
    Vtb_environment__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered[0U])) {
        Vtb_environment_tb_environment___stl_sequent__TOP__tb_environment__0((&vlSymsp->TOP__tb_environment));
    }
}
...
VL_ATTR_COLD bool Vtb_environment___024root___eval_phase__stl(Vtb_environment___024root* vlSelf) {
    ...
    // Body
    Vtb_environment___024root___eval_triggers_vec__stl(vlSelf);
#ifdef VL_DEBUG
    ...
    if (__VstlExecute) {
        Vtb_environment___024root___eval_stl(vlSelf);
    }

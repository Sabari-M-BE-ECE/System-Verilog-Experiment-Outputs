...
Vtb_full_adder_tb_full_adder__03a__03agenerator::Vtb_full_adder_tb_full_adder__03a__03agenerator(Vtb_full_adder__Syms* __restrict vlSymsp, VlClassRef<Vtb_full_adder_std__03a__03amailbox__Tz1> gen2drv) {
...
VlCoroutine Vtb_full_adder_tb_full_adder__03a__03agenerator::__VnoInFunc_run(Vtb_full_adder__Syms* __restrict vlSymsp) {
    ...
    while (VL_GTS_III(32, 8U, unnamedblk1__DOT__i)) {
        ...
        if (VL_UNLIKELY(((0U != ((VlNull{} != this->__PVT__tr)
                                  ? ([&]() {
                                    VL_NULL_CHECK(this->__PVT__tr, "tb_full_adder.sv", 102)
            ...
            VL_NULL_CHECK(this->__PVT__tr, "tb_full_adder.sv", 109)->__VnoInFunc_display(vlSymsp);
            co_await VL_NULL_CHECK(this->__PVT__gen2drv, "tb_full_adder.sv", 111)->__VnoInFunc_put(vlSymsp, this->__PVT__tr);
        }
...
std::string VL_TO_STRING(const VlClassRef<Vtb_full_adder_tb_full_adder__03a__03agenerator>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtb_full_adder_tb_full_adder__03a__03agenerator::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtb_full_adder_tb_full_adder__03a__03agenerator::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtb_full_adder_tb_full_adder__03a__03agenerator::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_full_adder_tb_full_adder__03a__03agenerator::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtb_full_adder_tb_full_adder__03a__03agenerator::to_string_middle\n"); );
    // Body
    std::string out;

...
Vtb_full_adder_tb_full_adder__03a__03aenvironment::Vtb_full_adder_tb_full_adder__03a__03aenvironment(Vtb_full_adder__Syms* __restrict vlSymsp) {
...
VlCoroutine Vtb_full_adder_tb_full_adder__03a__03aenvironment::__VnoInFunc_run____Vfork_1__3(Vtb_full_adder__Syms* __restrict vlSymsp, VlForkSync __Vfork_1__sync) {
    ...
    // Body
    VL_KEEP_THIS;
    co_await VL_NULL_CHECK(this->__PVT__scb, "tb_full_adder.sv", 383)->__VnoInFunc_run(vlSymsp);
    __Vfork_1__sync.done("tb_full_adder.sv", 383);
    co_return;
}
...
VlCoroutine Vtb_full_adder_tb_full_adder__03a__03aenvironment::__VnoInFunc_run____Vfork_1__2(Vtb_full_adder__Syms* __restrict vlSymsp, VlForkSync __Vfork_1__sync) {
    ...
    // Body
    VL_KEEP_THIS;
    co_await VL_NULL_CHECK(this->__PVT__mon, "tb_full_adder.sv", 381)->__VnoInFunc_run(vlSymsp);
    __Vfork_1__sync.done("tb_full_adder.sv", 381);
    co_return;
}
...
VlCoroutine Vtb_full_adder_tb_full_adder__03a__03aenvironment::__VnoInFunc_run____Vfork_1__1(Vtb_full_adder__Syms* __restrict vlSymsp, VlForkSync __Vfork_1__sync) {
    ...
    // Body
    VL_KEEP_THIS;
    co_await VL_NULL_CHECK(this->__PVT__drv, "tb_full_adder.sv", 379)->__VnoInFunc_run(vlSymsp);
    __Vfork_1__sync.done("tb_full_adder.sv", 379);
    co_return;
}
...
VlCoroutine Vtb_full_adder_tb_full_adder__03a__03aenvironment::__VnoInFunc_run____Vfork_1__0(Vtb_full_adder__Syms* __restrict vlSymsp, VlForkSync __Vfork_1__sync) {
    ...
    // Body
    VL_KEEP_THIS;
    co_await VL_NULL_CHECK(this->__PVT__gen, "tb_full_adder.sv", 377)->__VnoInFunc_run(vlSymsp);
    __Vfork_1__sync.done("tb_full_adder.sv", 377);
    co_return;
}
...
std::string VL_TO_STRING(const VlClassRef<Vtb_full_adder_tb_full_adder__03a__03aenvironment>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtb_full_adder_tb_full_adder__03a__03aenvironment::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtb_full_adder_tb_full_adder__03a__03aenvironment::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtb_full_adder_tb_full_adder__03a__03aenvironment::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_full_adder_tb_full_adder__03a__03aenvironment::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtb_full_adder_tb_full_adder__03a__03aenvironment::to_string_middle\n"); );
    // Body
    std::string out;

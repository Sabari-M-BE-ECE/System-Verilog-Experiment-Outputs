...
Vtb_nbit_adder_std__03a__03amailbox__Tz1::Vtb_nbit_adder_std__03a__03amailbox__Tz1(Vtb_nbit_adder__Syms* __restrict vlSymsp, IData/*31:0*/ bound) {
...
VlCoroutine Vtb_nbit_adder_std__03a__03amailbox__Tz1::__VnoInFunc_put(Vtb_nbit_adder__Syms* __restrict vlSymsp, VlClassRef<Vtb_nbit_adder_tb_nbit_adder__03a__03atransaction> message) {
    ...
    // Locals
    CData/*0:0*/ __Vtrigprevexpr_hcf001851__0;
    __Vtrigprevexpr_hcf001851__0 = 0;
    // Body
    VL_KEEP_THIS;
    while (((0U != this->__PVT__m_bound) & VL_GTES_III(32, this->__PVT__m_queue.size(), this->__PVT__m_bound))) {
        if (VL_GTES_III(32, this->__PVT__m_queue.size(), this->__PVT__m_bound)) {
            CData/*0:0*/ __VdynTrigger_hf4ffc55b__0;
            __VdynTrigger_hf4ffc55b__0 = 0;
            __VdynTrigger_hf4ffc55b__0 = 0U;
            while ((1U & (~ (IData)(__VdynTrigger_hf4ffc55b__0)))) {
                co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                             nullptr, 
                                                             "@([true] (std::mailbox__Tz1.m_queue.size() < std::mailbox__Tz1.m_bound))", 
                                                             "/usr/local/share/verilator/include/verilated_std.sv", 
                                                             51);
                __Vtrigprevexpr_hcf001851__0 = VL_LTS_III(32, this->__PVT__m_queue.size(), this->__PVT__m_bound);
                __VdynTrigger_hf4ffc55b__0 = __Vtrigprevexpr_hcf001851__0;
                vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hf4ffc55b__0);
            }
...
VlCoroutine Vtb_nbit_adder_std__03a__03amailbox__Tz1::__VnoInFunc_get(Vtb_nbit_adder__Syms* __restrict vlSymsp, VlClassRef<Vtb_nbit_adder_tb_nbit_adder__03a__03atransaction> &message) {
    ...
    // Locals
    CData/*0:0*/ __Vtrigprevexpr_ha39c1433__0;
    __Vtrigprevexpr_ha39c1433__0 = 0;
    // Body
    VL_KEEP_THIS;
    while ((0U == this->__PVT__m_queue.size())) {
        if (VL_GTES_III(32, 0U, this->__PVT__m_queue.size())) {
            CData/*0:0*/ __VdynTrigger_ha1e3b95d__0;
            __VdynTrigger_ha1e3b95d__0 = 0;
            __VdynTrigger_ha1e3b95d__0 = 0U;
            while ((1U & (~ (IData)(__VdynTrigger_ha1e3b95d__0)))) {
                co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                             nullptr, 
                                                             "@([true] (32'sh0 < std::mailbox__Tz1.m_queue.size()))", 
                                                             "/usr/local/share/verilator/include/verilated_std.sv", 
                                                             67);
                __Vtrigprevexpr_ha39c1433__0 = VL_LTS_III(32, 0U, this->__PVT__m_queue.size());
                __VdynTrigger_ha1e3b95d__0 = __Vtrigprevexpr_ha39c1433__0;
                vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_ha1e3b95d__0);
            }
            co_await vlSymsp->TOP.__VdynSched.resumption(
                                                         nullptr, 
                                                         "@([true] (32'sh0 < std::mailbox__Tz1.m_queue.size()))", 
...
VlCoroutine Vtb_nbit_adder_std__03a__03amailbox__Tz1::__VnoInFunc_peek(Vtb_nbit_adder__Syms* __restrict vlSymsp, VlClassRef<Vtb_nbit_adder_tb_nbit_adder__03a__03atransaction> &message) {
    ...
    // Locals
    CData/*0:0*/ __Vtrigprevexpr_ha39c1433__1;
    __Vtrigprevexpr_ha39c1433__1 = 0;
    // Body
    VL_KEEP_THIS;
    while ((0U == this->__PVT__m_queue.size())) {
        if (VL_GTES_III(32, 0U, this->__PVT__m_queue.size())) {
            CData/*0:0*/ __VdynTrigger_ha1e3b95d__1;
            __VdynTrigger_ha1e3b95d__1 = 0;
            __VdynTrigger_ha1e3b95d__1 = 0U;
            while ((1U & (~ (IData)(__VdynTrigger_ha1e3b95d__1)))) {
                co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                             nullptr, 
                                                             "@([true] (32'sh0 < std::mailbox__Tz1.m_queue.size()))", 
                                                             "/usr/local/share/verilator/include/verilated_std.sv", 
                                                             84);
                __Vtrigprevexpr_ha39c1433__1 = VL_LTS_III(32, 0U, this->__PVT__m_queue.size());
                __VdynTrigger_ha1e3b95d__1 = __Vtrigprevexpr_ha39c1433__1;
                vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_ha1e3b95d__1);
            }
            co_await vlSymsp->TOP.__VdynSched.resumption(
                                                         nullptr, 
                                                         "@([true] (32'sh0 < std::mailbox__Tz1.m_queue.size()))", 
...
std::string VL_TO_STRING(const VlClassRef<Vtb_nbit_adder_std__03a__03amailbox__Tz1>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_nbit_adder_std__03a__03amailbox__Tz1::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtb_nbit_adder_std__03a__03amailbox__Tz1::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_nbit_adder_std__03a__03amailbox__Tz1::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_nbit_adder_std__03a__03amailbox__Tz1::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_nbit_adder_std__03a__03amailbox__Tz1::to_string_middle\n"); );
    // Body
    std::string out;

...
Vtransaction_random_std__03a__03aprocess::Vtransaction_random_std__03a__03aprocess(Vtransaction_random__Syms* __restrict vlSymsp) {
...
std::string VL_TO_STRING(const VlClassRef<Vtransaction_random_std__03a__03aprocess>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtransaction_random_std__03a__03aprocess::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtransaction_random_std__03a__03aprocess::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtransaction_random_std__03a__03aprocess::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtransaction_random_std__03a__03aprocess::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtransaction_random_std__03a__03aprocess::to_string_middle\n"); );
    // Body
    std::string out;

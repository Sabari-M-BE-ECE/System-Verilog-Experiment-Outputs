...
VL_ATTR_COLD void Vtransaction_random_std___ctor_var_reset(Vtransaction_random_std* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtransaction_random_std___ctor_var_reset\n"); );

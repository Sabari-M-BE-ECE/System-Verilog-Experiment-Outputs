...
VL_ATTR_COLD void Vprocess_communication_std___ctor_var_reset(Vprocess_communication_std* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vprocess_communication_std___ctor_var_reset\n"); );
